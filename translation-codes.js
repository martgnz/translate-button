const languages = {
  ...
  yandex: [
    ...
    { name: "Kannada", code: "kn" },
    { name: "Kazakh", code: "kk" },
    { name: "Kazakh (Latin) (Beta)", code: "kazlat" },
    { name: "Khmer", code: "km" },
    { name: "Korean", code: "ko" },
    { name: "Kyrgyz (Beta)", code: "ky" },
    { name: "Lao (Beta)", code: "lo" },
    { name: "Latin", code: "la" },
    { name: "Latvian", code: "lv" },
    { name: "Lithuanian", code: "lt" },
    { name: "Luxembourgish", code: "lb" },
    ...
    { name: "Malagasy", code: "mg" },
    { name: "Malay", code: "ms" },
    { name: "Malayalam (Beta)", code: "ml" },
    { name: "Maltese", code: "mt" },
    { name: "Maori", code: "mi" },
    { name: "Marathi", code: "mr" },
    { name: "Mari (Beta)", code: "mhr" },
    { name: "Mongolian (Beta)", code: "mn" },
    { name: "Nepali", code: "ne" },
    { name: "Norwegian", code: "no" },
    { name: "Papiamento (Beta)", code: "pap" },
    { name: "Persian", code: "fa" },
    { name: "Polish", code: "pl" },
    { name: "Portuguese", code: "pt" },
    { name: "Punjabi", code: "pa" },
    ...
    { name: "Tajik (Beta)", code: "tg" },
    { name: "Tamil (Beta)", code: "ta" },
    { name: "Tatar", code: "tt" },
    { name: "Telugu (Beta)", code: "te" },
    { name: "Thai", code: "th" },
    { name: "Turkish", code: "tr" },
    { name: "Udmurt (Beta)", code: "udm" },
    { name: "Ukrainian", code: "uk" },
    { name: "Urdu", code: "ur" },
    { name: "Uzbek", code: "uz" },
    { name: "Uzbek (Cyrillic)", code: "uzbcyr" },
    { name: "Vietnamese", code: "vi" },
    { name: "Welsh", code: "cy" },
    { name: "Xhosa (Beta)", code: "xh" },
    { name: "Yakut (Beta)", code: "sah" },
    { name: "Yiddish", code: "yi" },
  ],
};
